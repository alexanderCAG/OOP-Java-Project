...
public class Reset extends javax.swing.JFrame {
    ...
    /*Permet de vérifier le nouveau mot de passe et update dans la base de donnée*/
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        
        if(jTextField1.getText().equals(jTextField2.getText()))     //vérification du nouveau mot de passe
        {
            try{
                Connection conn = Connexion1();
                String updateQuery = "UPDATE `employer` SET `motdepasse`=? WHERE email=?";  //Update dans la base de donnée
