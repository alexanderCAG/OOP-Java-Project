...
public class Controller {
    public static void Verificationcandidat(String user, String password, Login l) throws SQLException{
    ...
    public static void Verificationemployer(String user, String password, Login l) throws SQLException{
        Connection conn = Connexion1();
        try{
        Statement stmt = conn.createStatement();
    ...
    public static void Verificationrecruiter(String user, String password, Login l) throws SQLException{
        Connection conn = Connexion1();
        try{
        Statement stmt = conn.createStatement();
